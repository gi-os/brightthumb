...
import com.gios.brightthumb.keyboards.KB_AR_THUMBKEY_LEVANT
import com.gios.brightthumb.keyboards.KB_BG_MESSAGEASE_PHONETIC_SYMBOLS
import com.gios.brightthumb.keyboards.KB_BG_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_BN_THUMBKEY
import com.gios.brightthumb.keyboards.KB_BR_FR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_BR_FR_THUMBKEY_COMPOSE
import com.gios.brightthumb.keyboards.KB_BR_FR_THUMBKEY_V3
import com.gios.brightthumb.keyboards.KB_BY_THUMBKEY
import com.gios.brightthumb.keyboards.KB_BY_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_CA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_CZ_MESSAGEASE_PROGRAMMING
import com.gios.brightthumb.keyboards.KB_DA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_DA_THUMBKEY_MULTILINGUAL
import com.gios.brightthumb.keyboards.KB_DE_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_DE_MESSAGEASE_INVERTED_NUMPAD
import com.gios.brightthumb.keyboards.KB_DE_MESSAGEASE_LEFT
import com.gios.brightthumb.keyboards.KB_DE_MESSAGEASE_LEFT_INVERTED_NUMPAD
import com.gios.brightthumb.keyboards.KB_DE_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_DE_NORDIC_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_DE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_DE_THUMBKEY_MULTILINGUAL
import com.gios.brightthumb.keyboards.KB_DE_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_DE_THUMBKEY_SYMNUM
import com.gios.brightthumb.keyboards.KB_DE_THUMBKEY_WORDS
import com.gios.brightthumb.keyboards.KB_DE_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_DE_TYPESPLIT_IMPROVED
import com.gios.brightthumb.keyboards.KB_DE_TYPESPLIT_SUAVE
import com.gios.brightthumb.keyboards.KB_ENLV_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_COLUMNAR
import com.gios.brightthumb.keyboards.KB_EN_COLUMNAR_QUICK
import com.gios.brightthumb.keyboards.KB_EN_CZ_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_DA_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_DE_NL_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_DE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_DE_THUMBKEY_AE
import com.gios.brightthumb.keyboards.KB_EN_DE_THUMBKEY_V2
import com.gios.brightthumb.keyboards.KB_EN_DOUBLE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_DVORAK_WIDE
import com.gios.brightthumb.keyboards.KB_EN_DVORAK_WIDE_COMPOSE
import com.gios.brightthumb.keyboards.KB_EN_EE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_EO_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_EO_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_ES_CA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_ES_CA_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_FR_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_HR_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_EN_HYPER
import com.gios.brightthumb.keyboards.KB_EN_HYPER_SPACE
import com.gios.brightthumb.keyboards.KB_EN_IT_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_LA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_MARLIN
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_COMPOSE
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_COMPOSE_LEFT_FLIPPED_NUMPAD
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_LEFT
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_LEFT_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_SYMBOLS_MODIFIERS
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_SYMBOLS_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_MESSAGEASE_WRITER
import com.gios.brightthumb.keyboards.KB_EN_MINNOW
import com.gios.brightthumb.keyboards.KB_EN_MI_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_MI_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_NL_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_EN_NO_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_NO_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_NO_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_EN_PH_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_EN_PL_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_QBASED
import com.gios.brightthumb.keyboards.KB_EN_QBASED_LEFT
import com.gios.brightthumb.keyboards.KB_EN_QWERTEASE
import com.gios.brightthumb.keyboards.KB_EN_QWERTEASE_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_QWERTYFOUR
import com.gios.brightthumb.keyboards.KB_EN_QWERTYFOUR_COMPOSE
import com.gios.brightthumb.keyboards.KB_EN_RO_HYPER
import com.gios.brightthumb.keyboards.KB_EN_RO_HYPER_SPACE
import com.gios.brightthumb.keyboards.KB_EN_RO_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_RSINOA
import com.gios.brightthumb.keyboards.KB_EN_SK_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_SV_THUMBKEY_PROGRAMMING
import com.gios.brightthumb.keyboards.KB_EN_SYMBOLS_NUMBERS_ARROWS_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_SYMBOLS_NUMBERS_ARROWS_TWO_HANDS_COMPACT
import com.gios.brightthumb.keyboards.KB_EN_SYMBOLS_NUMBERS_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_SYMBOLS_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_COMPACT
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_COMPOSE
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_FLIPPED_NUMPAD
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_PROGRAMMING
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_PROGRAMMING_EXPANDED
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_PROGRAMMING_WIDE
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_SHIFT
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WIDE
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WIDE_COMPOSE
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WORDS
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WORDS_SHIFT
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WORDS_SYMBOLS
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WORDS_SYMBOLS_DUAL
import com.gios.brightthumb.keyboards.KB_EN_THUMBKEY_WRITER
import com.gios.brightthumb.keyboards.KB_EN_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_EN_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_EN_TYPESPLIT_PROGRAMMING
import com.gios.brightthumb.keyboards.KB_EN_TYPESPLIT_SHORT
import com.gios.brightthumb.keyboards.KB_EN_WHALE
import com.gios.brightthumb.keyboards.KB_EO_CYRILLIC_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EO_EN_DE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_ES_CA_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_ES_CA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_ES_EO_THUMBKEY
import com.gios.brightthumb.keyboards.KB_ES_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_ES_THUMBKEY
import com.gios.brightthumb.keyboards.KB_ES_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_ES_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_EUROPE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EU_ES_THUMBKEY
import com.gios.brightthumb.keyboards.KB_EU_THUMBKEY
import com.gios.brightthumb.keyboards.KB_FA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_FA_THUMBKEY_SAMSUNG
import com.gios.brightthumb.keyboards.KB_FI_EE_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_FI_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_FI_THUMBKEY
import com.gios.brightthumb.keyboards.KB_FI_THUMBKEY_WIDE
import com.gios.brightthumb.keyboards.KB_FI_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_FR_EN_FRAPPE_FLUIDE_V1
import com.gios.brightthumb.keyboards.KB_FR_EN_FRAPPE_FLUIDE_V1_CONTROL_LEFT_SIDE
import com.gios.brightthumb.keyboards.KB_FR_EN_FRAPPE_FLUIDE_V1_LEFT_HANDED
import com.gios.brightthumb.keyboards.KB_FR_EN_FRAPPE_FLUIDE_V1_LEFT_HANDED_CONTROL_LEFT_SIDE
import com.gios.brightthumb.keyboards.KB_FR_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_FR_MESSAGEASE_LEFT_FLIPPED_NUMPAD
import com.gios.brightthumb.keyboards.KB_FR_THUMBKEY_V1
import com.gios.brightthumb.keyboards.KB_FR_THUMBKEY_V2
import com.gios.brightthumb.keyboards.KB_FR_THUMBKEY_V3
import com.gios.brightthumb.keyboards.KB_FR_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_GLAGOLITIC_THUMBKEY
import com.gios.brightthumb.keyboards.KB_GRNORM_THUMBKEY
import com.gios.brightthumb.keyboards.KB_GRNORM_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_GR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_HE_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_HE_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_HE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_HI_THUMBKEY
import com.gios.brightthumb.keyboards.KB_HI_THUMBKEY_EXTENDED
import com.gios.brightthumb.keyboards.KB_HR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_HR_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_HR_TWO_HANDS
import com.gios.brightthumb.keyboards.KB_HU_HUNGRAM
import com.gios.brightthumb.keyboards.KB_HU_THUMBKEY
import com.gios.brightthumb.keyboards.KB_HU_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_ID_THUMBKEY_SYMBOLS_NUMBERS_V1
import com.gios.brightthumb.keyboards.KB_ID_THUMBKEY_SYMBOLS_V1
import com.gios.brightthumb.keyboards.KB_ID_THUMBKEY_SYMBOLS_V2
import com.gios.brightthumb.keyboards.KB_IT_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_IT_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_IT_THUMBKEY
import com.gios.brightthumb.keyboards.KB_IT_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_JA_HIRAGANA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_JA_HIRAGANA_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_JA_KANA_STANDARD
import com.gios.brightthumb.keyboards.KB_JA_KANA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_JA_KATAKANA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_JA_KATAKANA_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_KA_THUMBKEY
import com.gios.brightthumb.keyboards.KB_KN_THUMBKEY
import com.gios.brightthumb.keyboards.KB_KR_ONETHUMB
import com.gios.brightthumb.keyboards.KB_KR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_KR_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_KZ_THUMBKEY
import com.gios.brightthumb.keyboards.KB_LT_THUMBKEY
import com.gios.brightthumb.keyboards.KB_LV_LTG_THUMBKEY
import com.gios.brightthumb.keyboards.KB_MATH_THUMBKEY
import com.gios.brightthumb.keyboards.KB_MY_THUMBKEY
import com.gios.brightthumb.keyboards.KB_MY_WHALE
import com.gios.brightthumb.keyboards.KB_NL_THUMBKEY
import com.gios.brightthumb.keyboards.KB_NL_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_NO_THUMBKEY
import com.gios.brightthumb.keyboards.KB_NO_THUMBKEY_DATADRIVEN
import com.gios.brightthumb.keyboards.KB_PL_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_PL_THUMBKEY
import com.gios.brightthumb.keyboards.KB_PL_TYPESPLIT_SYMBOLS_V1
import com.gios.brightthumb.keyboards.KB_PL_TYPESPLIT_SYMBOLS_V2
import com.gios.brightthumb.keyboards.KB_PL_TYPESPLIT_V1
import com.gios.brightthumb.keyboards.KB_PL_TYPESPLIT_V2
import com.gios.brightthumb.keyboards.KB_PT_DVORAK_WIDE
import com.gios.brightthumb.keyboards.KB_PT_EN_THUMBKEY
import com.gios.brightthumb.keyboards.KB_PT_THUMBKEY
import com.gios.brightthumb.keyboards.KB_PT_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_RU_ARTI
import com.gios.brightthumb.keyboards.KB_RU_HYPER
import com.gios.brightthumb.keyboards.KB_RU_HYPER_SPACE
import com.gios.brightthumb.keyboards.KB_RU_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_RU_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_RU_MESSAGEASE_WRITER
import com.gios.brightthumb.keyboards.KB_RU_MESSAGE_OWL
import com.gios.brightthumb.keyboards.KB_RU_THUMBKEY
import com.gios.brightthumb.keyboards.KB_RU_THUMBKEY_SYMBOLS
import com.gios.brightthumb.keyboards.KB_RU_THUMBKEY_WRITER
import com.gios.brightthumb.keyboards.KB_SAH_THUMBKEY_WRITER
import com.gios.brightthumb.keyboards.KB_SCANDINAVIAN_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_SK_THUMBKEY_V1
import com.gios.brightthumb.keyboards.KB_SK_THUMBKEY_V2
import com.gios.brightthumb.keyboards.KB_SK_THUMBKEY_V3
import com.gios.brightthumb.keyboards.KB_SL_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_SRLATN_EN_DE_THUMBKEY
import com.gios.brightthumb.keyboards.KB_SRLATN_THUMBKEY
import com.gios.brightthumb.keyboards.KB_SR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_SV_MESSAGEASE
import com.gios.brightthumb.keyboards.KB_SV_THUMBKEY
import com.gios.brightthumb.keyboards.KB_T9
import com.gios.brightthumb.keyboards.KB_TH_THUMBKEY
import com.gios.brightthumb.keyboards.KB_TH_THUMBKEY_KHAM_CHUEAM
import com.gios.brightthumb.keyboards.KB_TOK_SITELEN_THUMBKEY_EMOJI
import com.gios.brightthumb.keyboards.KB_TOK_THUMBKEY
import com.gios.brightthumb.keyboards.KB_TOK_THUMBKEY_LETTERS_SHIFT
import com.gios.brightthumb.keyboards.KB_TR_ARTI
import com.gios.brightthumb.keyboards.KB_TR_THUMBKEY
import com.gios.brightthumb.keyboards.KB_TR_TYPESPLIT
import com.gios.brightthumb.keyboards.KB_UK_BY_RU_THUMBKEY
import com.gios.brightthumb.keyboards.KB_UK_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_UK_RU_MESSAGEASE_SYMBOLS
import com.gios.brightthumb.keyboards.KB_UK_THUMBKEY
import com.gios.brightthumb.keyboards.KB_VN_THUMBKEY
