...
val KB_BR_FR_THUMBKEY_V3_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_BR_FR_THUMBKEY_V3: KeyboardDefinition =
    KeyboardDefinition(
        title = "brezhoneg français thumb-key v3",
        modes =
            KeyboardDefinitionModes(
                main = KB_BR_FR_THUMBKEY_V3_MAIN,
