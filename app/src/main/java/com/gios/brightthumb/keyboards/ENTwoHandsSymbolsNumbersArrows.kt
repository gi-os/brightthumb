...
val KB_EN_SYMBOLS_NUMBERS_ARROWS_TWO_HANDS_MAIN =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
...
val KB_EN_SYMBOLS_NUMBERS_ARROWS_TWO_HANDS_SHIFTED =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
    ...
    KeyboardDefinition(
        ...
        modes =
            KeyboardDefinitionModes(
                ...
                shifted = KB_EN_SYMBOLS_NUMBERS_ARROWS_TWO_HANDS_SHIFTED,
                numeric = TWO_HANDS_NUMERIC_ARROWS_KEYBOARD,
            ),
        settings =
