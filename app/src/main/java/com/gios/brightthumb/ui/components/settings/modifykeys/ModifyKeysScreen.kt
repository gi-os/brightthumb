package com.gios.brightthumb.ui.components.settings.modifykeys
...
import com.gios.brightthumb.db.KeyModificationsUpdate
...
import com.gios.brightthumb.utils.checkAllKeyboardModifications
...
fun ModifyKeysScreen(
    ...
    if (!keyMods.isNullOrEmpty()) {
        checkAllKeyboardModifications(keyMods, keyModificationsError)
    }
